...
Dialog.prototype.dragDown = function(ev) {
...
Dialog.prototype.dragMove = function(ev) {
	var ev = ev || event;
...
Dialog.prototype.dragUp = function() {
...
// 点击x关闭
Dialog.prototype.oCloseClick = function(){
	var _this = this;
...
// 设置对话框的返回值
Dialog.prototype.return = function() {
	var _this = this;			
